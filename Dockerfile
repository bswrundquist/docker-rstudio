...
RUN R -e "install.packages('msgpack', dependencies=TRUE, repos='http://cran.rstudio.com/')"
...
RUN R -e "install.packages('trelliscopejs', dependencies=TRUE, repos='http://cran.rstudio.com/')"
